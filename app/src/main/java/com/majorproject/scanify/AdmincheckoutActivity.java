...
public class AdmincheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admincheckout);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    Toast.makeText(AdmincheckoutActivity.this,"Exception: "+e.getMessage(),Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        //checkout button
            ...
            public void onClick(View v) {
                if(productList.size()>0)
                    ...
                    Toast.makeText(AdmincheckoutActivity.this,"Please add atleast one item to checkout",Toast.LENGTH_SHORT).show();
                }
    ...
    public void checkout() {
        ...
        Intent intent = new Intent(this,Admincheckout2Activity.class);
               ...
               /* String post = "Amount : "+dataSnapshot.child("amount").getValue(Product.class)+"\n"
                        ...
                        if (dataSnapshot.getValue()!=null) {
                            ...
                            if(quantity>0) {
                                ...
                                Toast.makeText(AdmincheckoutActivity.this,"Product Out of Stock",Toast.LENGTH_SHORT).show();
                            }
                        }
                        if(found==false) {
                            Toast.makeText(AdmincheckoutActivity.this, "This Product is not in Your Inventory", Toast.LENGTH_SHORT).show();
                        }
                        CheckoutListAdptr adapter = new CheckoutListAdptr(AdmincheckoutActivity.this, productList);
                        listViewAllProducts.setAdapter(adapter);
                    }
                    @Override
                    public void onCancelled(@NonNull DatabaseError databaseError) {
                        Toast.makeText(AdmincheckoutActivity.this,"Something Went Wrong, Please Try Again!",Toast.LENGTH_SHORT).show();
                    }
                });
            }
    ...
    public void onBackPressed() {
        Intent intent = new Intent(AdmincheckoutActivity.this,MainActivity.class);
        startActivity(intent);
        finish();
    }
}